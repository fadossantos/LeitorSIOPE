...
public class SiopeInitializer {
    ...
    @Autowired
    ContaMvpnService contaMvpnService;
    ...
    @Autowired
    SituacaoInvestimentoService situacaoInvestimentoService;
    ...
    @Autowired
    TipoPendenciaService tipoPendenciaService;
    ...
    private void init() {
        buildAdmin();
        carregaPaises();
        carregaEstadosBrasil();
        carregaCidadesBrasil();
        carregaEstadoCivil();
        carregaSituacaoInvestimento();
        carregaStatus();
        carregaTipoConta();
        carregaTipoInvestimento();
        carregaTipoPendencia();
        carregaTipoTelefone();
        carregaTipoTransacao();
    }

    private void buildAdmin() {
        ContaMvpn admin = contaMvpnService.findbyLogin("admin");
        ...
        try {
            ...
            if (admin == null) {
                ...
                contaMvpnService.addOrUpdate(admin);
                ContaMvpn user = new ContaMvpn();
                ...
                contaMvpnService.addOrUpdate(user);
            }
    ...
    private void carregaPaises() {
        ...
        if (Iterables.isEmpty(paisService.findAll())) {
            //region listaPaises
            String[] listaPaises = new String[]{
                    "Afeganistão"
                    , "África do Sul"
                    , "Akrotiri"
                    , "Albânia"
            ...
            for (String pais : listaPaises) {
                ...
                paisNovo.setDescPais(pais);
                paisService.addOrUpdate(paisNovo);
            }
        }

    }

    private void carregaEstadosBrasil() {
        if (Iterables.isEmpty(estadoService.findAll())) {
            Pais pais = paisService.findByDescPais("Brasil");
            //region listaEstados
            ...
            for (String estado : listaEstados) {
                ...
                estadoNovo.setDescEstado(estado);
                estadoService.addOrUpdate(estadoNovo);
            }
        }

    }

    private void carregaCidadesBrasil() {
        if (Iterables.isEmpty(cidadeService.findAll())) {

            //region LoadEstados
            Estado acre = estadoService.findByDescEstado("Acre");
            Estado alagoas = estadoService.findByDescEstado("Alagoas");
            Estado amapa = estadoService.findByDescEstado("Amapá");
            Estado amazonas = estadoService.findByDescEstado("Amazonas");
            Estado bahia = estadoService.findByDescEstado("Bahia");
            Estado ceara = estadoService.findByDescEstado("Ceará");
            Estado distritofederal = estadoService.findByDescEstado("Distrito Federal");
            Estado espiritosanto = estadoService.findByDescEstado("Espírito Santo");
            Estado goias = estadoService.findByDescEstado("Goiás");
            Estado maranhao = estadoService.findByDescEstado("Maranhão");
            Estado matogrosso = estadoService.findByDescEstado("Mato Grosso");
            Estado matogrossodosul = estadoService.findByDescEstado("Mato Grosso do Sul");
            Estado minasgerais = estadoService.findByDescEstado("Minas Gerais");
            Estado para = estadoService.findByDescEstado("Pará");
            Estado paraiba = estadoService.findByDescEstado("Paraíba");
            Estado parana = estadoService.findByDescEstado("Paraná");
            Estado pernambuco = estadoService.findByDescEstado("Pernambuco");
            Estado piaui = estadoService.findByDescEstado("Piauí");
            Estado riodejaneiro = estadoService.findByDescEstado("Rio de Janeiro");
            Estado riograndedonorte = estadoService.findByDescEstado("Rio Grande do Norte");
            Estado riograndedosul = estadoService.findByDescEstado("Rio Grande do Sul");
            Estado rondonia = estadoService.findByDescEstado("Rondônia");
            Estado roraima = estadoService.findByDescEstado("Roraima");
            Estado santacaratina = estadoService.findByDescEstado("Santa Catarina");
            Estado saopaulo = estadoService.findByDescEstado("São Paulo");
            Estado sergipe = estadoService.findByDescEstado("Sergipe");
            Estado tocantins = estadoService.findByDescEstado("Tocantins");
            //endregion
            //region ListaCidades
            String[] listaCidades = new String[]{
            ...
            for (String cidade : listaCidades) {
                ...
                String[] cidadeSplited = cidade.split("\\|");
                switch (cidadeSplited[0].substring(0, 2)) {
                    //region CaseEstados
                    case "11":
                        cidadeNova.setEstado(rondonia);
                        break;
                    case "12":
                        cidadeNova.setEstado(acre);
                        break;
                    case "13":
                        cidadeNova.setEstado(amazonas);
                        break;
                    case "14":
                        cidadeNova.setEstado(roraima);
                        break;
                    case "15":
                        cidadeNova.setEstado(para);
                        break;
                    case "16":
                        cidadeNova.setEstado(amapa);
                        break;
                    case "17":
                        cidadeNova.setEstado(tocantins);
                        break;
                    case "21":
                        cidadeNova.setEstado(maranhao);
                        break;
                    case "22":
                        cidadeNova.setEstado(piaui);
                        break;
                    case "23":
                        cidadeNova.setEstado(ceara);
                        break;
                    case "24":
                        cidadeNova.setEstado(riograndedonorte);
                        break;
                    case "25":
                        cidadeNova.setEstado(paraiba);
                        break;
                    case "26":
                        cidadeNova.setEstado(pernambuco);
                        break;
                    case "27":
                        cidadeNova.setEstado(alagoas);
                        break;
                    case "28":
                        cidadeNova.setEstado(sergipe);
                        break;
                    case "29":
                        cidadeNova.setEstado(bahia);
                        break;
                    case "31":
                        cidadeNova.setEstado(minasgerais);
                        break;
                    case "32":
                        cidadeNova.setEstado(espiritosanto);
                        break;
                    case "33":
                        cidadeNova.setEstado(riodejaneiro);
                        break;
                    case "35":
                        cidadeNova.setEstado(saopaulo);
                        break;
                    case "41":
                        cidadeNova.setEstado(parana);
                        break;
                    case "42":
                        cidadeNova.setEstado(santacaratina);
                        break;
                    case "43":
                        cidadeNova.setEstado(riograndedosul);
                        break;
                    case "50":
                        cidadeNova.setEstado(matogrossodosul);
                        break;
                    case "51":
                        cidadeNova.setEstado(matogrosso);
                        break;
                    case "52":
                        cidadeNova.setEstado(goias);
                        break;
                    case "53":
                        cidadeNova.setEstado(distritofederal);
                        break;
                    //endregion
                }
                cidadeNova.setDescCidade(cidadeSplited[1]);
                cidadeNova.setCodigo(Long.valueOf(cidadeSplited[0]));
                cidadeService.addOrUpdate(cidadeNova);
            }
        }
    }

    private void carregaEstadoCivil() {
        if (Iterables.isEmpty(estadoCivilService.findAll())) {
            String[] listaEstadoCivil = new String[]{
                    "Solteiro(a)", "Casado(a)", "Divorciado(a)", "Viúvo(a)", "Separado(a)"
            };
            for (String strEstadoCivil : listaEstadoCivil) {
                EstadoCivil estadoCivil = new EstadoCivil();
                estadoCivil.setDescEstadoCivil(strEstadoCivil);
                estadoCivilService.addOrUpdate(estadoCivil);
            }
        }
    }

    private void carregaSituacaoInvestimento() {
        if (Iterables.isEmpty(situacaoInvestimentoService.findAll())) {
            String[] listaStr = new String[]{
                    "Situação 1", "Situação 2", "Situação 3", "Situação 4", "Situação 5"
            };
            for (String str : listaStr) {
                SituacaoInvestimento obj = new SituacaoInvestimento();
                obj.setDescSituacaoInvestimento(str);
                situacaoInvestimentoService.addOrUpdate(obj);
            }
        }
    }

    private void carregaStatus() {
        if (Iterables.isEmpty(statusService.findAll())) {
            String[] listaStr = new String[]{
                    "Status 1", "Status 2", "Status 3", "Status 4", "Status 5"
            };
            for (String str : listaStr) {
                Status obj = new Status();
                obj.setDescStatus(str);
                statusService.addOrUpdate(obj);
            }
        }
    }

    private void carregaTipoConta() {
        if (Iterables.isEmpty(tipoContaService.findAll())) {
            String[] listaStr = new String[]{
                    "TipoConta 1", "TipoConta 2", "TipoConta 3", "TipoConta 4", "TipoConta 5"
            };
            for (String str : listaStr) {
                TipoConta obj = new TipoConta();
                obj.setDescTipoConta(str);
                tipoContaService.addOrUpdate(obj);
            }
        }
    }

    private void carregaTipoInvestimento() {
        if (Iterables.isEmpty(tipoInvestimentoService.findAll())) {
            String[] listaStr = new String[]{
                    "TipoInvestimento 1", "TipoInvestimento 2", "TipoInvestimento 3", "TipoInvestimento 4", "TipoInvestimento 5"
            };
            for (String str : listaStr) {
                TipoInvestimento obj = new TipoInvestimento();
                obj.setDescTipoInvestimento(str);
                obj.setSituacao(true);
                tipoInvestimentoService.addOrUpdate(obj);
            }
        }
    }

    private void carregaTipoPendencia() {
        if (Iterables.isEmpty(tipoPendenciaService.findAll())) {
            String[] listaStr = new String[]{
                    "TipoPendencia 1", "TipoPendencia 2", "TipoPendencia 3", "TipoPendencia 4", "TipoPendencia 5"
            };
            for (String str : listaStr) {
                TipoPendencia obj = new TipoPendencia();
                obj.setDescTipoPendencia(str);
                tipoPendenciaService.addOrUpdate(obj);
            }
        }
    }

    private void carregaTipoTelefone() {
        if (Iterables.isEmpty(tipoTelefoneService.findAll())) {
            String[] listaStr = new String[]{
                    "Residencial", "Celular", "Recado", "Comercial"
            };
            for (String str : listaStr) {
                TipoTelefone obj = new TipoTelefone();
                obj.setDescTipoTelefone(str);
                tipoTelefoneService.addOrUpdate(obj);
            }
        }
    }

    private void carregaTipoTransacao() {
        if (Iterables.isEmpty(tipoTransacaoService.findAll())) {
            String[] listaStr = new String[]{
                    "TipoTransacao 1", "TipoTransacao 2", "TipoTransacao 3", "TipoTransacao 4", "TipoTransacao 5"
            };
            for (String str : listaStr) {
                TipoTransacao obj = new TipoTransacao();
                obj.setDescTipoTransacao(str);
                tipoTransacaoService.addOrUpdate(obj);
            }
        }
    }
